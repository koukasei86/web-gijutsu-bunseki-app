...
const lessons = [
 { title:'見出しを作ろう', explanation:'HTMLは画面の構造を作る言語です。h1タグは、ページで最も大きな見出しを表します。', task:'h1タグを使って「こんにちは」と表示してください。', hint:'開始タグと終了タグの間に文字を入れます。', initial:'<!-- ここに見出しを書いてみよう -->', answer:'<h1>こんにちは</h1>' },
